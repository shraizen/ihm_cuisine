    ...
    , ui(new Ui::MainWindow)
{
    ...
    QPixmap fondPresentation("../RecipesReader/images/reacipesReader.png");
    ui->labelfond->setPixmap(fondPresentation);
    QPalette pal = palette();
    setStyleSheet( "QWidget#Description, QWidget#Ingredients, QWidget#Etapes, QWidget#Informations{background-image:url('../RecipesReader/images/fond.png');}");
    setFixedSize(800,600);
    ui->labelfond->raise();
    ui->labelfond2->raise();
    ui->labelfond2->setAlignment(Qt::AlignCenter);
...
void MainWindow::OuvrirFichier(const QString &path)
{
    ...
    {
        QFileDialog dialog;
        nomFichier = dialog.getOpenFileName(this, tr("Ouvrir le fichier"), "", tr("Fichiers JSON (*.json)"));   ///Ouvre une fenetre de dialoque et de recherche de fichier JSON
    }
...
void MainWindow::dragEnterEvent(QDragEnterEvent *e)
{
    if (e->mimeData()->hasUrls()) {
        ...
        QPixmap fond2("../RecipesReader/images/drag-and-drop-png.png");
        ui->labelfond2->setPixmap(fond2);
    }
    ui->labelfond2->show();
}

/**
 * \fn void MainWindow::dragLeaveEvent(QDragLeaveEvent *event)
